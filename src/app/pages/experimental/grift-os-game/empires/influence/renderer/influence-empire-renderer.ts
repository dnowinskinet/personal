...
export class InfluenceEmpireRendererComponent {
  ...
  get rugPullView(): InfluenceRugPullView {
    ...
    return {
      ...
      extractionRateLabel: presentation.extractionRateLabel,
      extractionNextCostLabel: presentation.extractionNextCostLabel,
      extractionDurationLabel: presentation.extractionDurationLabel,
      extractionRemainingLabel: presentation.extractionRemainingLabel,
      extractionOutputLabel: presentation.extractionOutputLabel,
      extractionNextOutputLabel: presentation.extractionNextOutputLabel,
      extractionProgressScale: presentation.extractionProgressScale,
